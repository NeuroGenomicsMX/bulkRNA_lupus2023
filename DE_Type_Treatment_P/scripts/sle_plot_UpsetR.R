...
# My computer
indir <- "C:/Users/ecoss/OneDrive - CINVESTAV/Documentos/Posdoc_LIIGH/LUPUS_Proyecto_2023/bulkRNA_lupus2023/DE_Type_Treatment_P/DE_files/"
load(paste0(indir, 'DE_SLE_results.RData'))

# figdir <- '/mnt/Citosina/amedina/lupus/RNA_lupus/DE_P_C_celltypes/figures/'
figdir <- 'C:/Users/ecoss/OneDrive - CINVESTAV/Documentos/Posdoc_LIIGH/LUPUS_Proyecto_2023/bulkRNA_lupus2023/DE_Type_Treatment_P/figures/'
...
upset(fromList(UpsetR_data), # Convert Dataset to matrix
      ...
      set_size.scale_max = 6000, #aumentar escala del set
...
ss <- c("SLE_moVSmoDC_UP", "SLE_moVSmoDCIMQ_UP", "SLE_moVStolDC_UP", "SLE_moVStolDCIMQ_UP",
        "SLE_moVSmoDC_DOWN", "SLE_moVSmoDCIMQ_DOWN", "SLE_moVStolDC_DOWN", "SLE_moVStolDCIMQ_DOWN")
cs <- comb_size(m1) # Number of intersect


# Grupos
subgroup <- c("SLE_moVSmoDC_UP" = "moDC",
              "SLE_moVSmoDCIMQ_UP" = "moDC",
              "SLE_moVStolDC_UP" = "tolDC",
              "SLE_moVStolDCIMQ_UP" = "tolDC",
              "SLE_moVSmoDC_DOWN" = "moDC",
              "SLE_moVSmoDCIMQ_DOWN" = "moDC",
              "SLE_moVStolDC_DOWN" = "tolDC",
              "SLE_moVStolDCIMQ_DOWN" = "tolDC"
)

expressed <- c("SLE_moVSmoDC_UP" = "UP",
               "SLE_moVSmoDCIMQ_UP" = "UP",
               "SLE_moVStolDC_UP" = "UP",
               "SLE_moVStolDCIMQ_UP" = "UP",
               "SLE_moVSmoDC_DOWN" = "DOWN",
               "SLE_moVSmoDCIMQ_DOWN" = "DOWN",
               "SLE_moVStolDC_DOWN" = "DOWN",
               "SLE_moVStolDCIMQ_DOWN" = "DOWN"
)
